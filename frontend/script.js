document.addEventListener('DOMContentLoaded', () => {
  ...
  const columnDefs = [
    ...
    { headerName: "Ref Quarter", field: "q", editable: true, cellEditor: 'agSelectCellEditor', cellEditorParams: { values: ['', 'Q1', 'Q2', 'Q3', 'Q4'] }, minWidth: 120 },
    { headerName: "Ref do cliente (C3)", field: "c3", minWidth: 150 },
    { headerName: "Delivery ID", field: "deliveryid", minWidth: 150 },
    { headerName: "Status de liberação", field: "sostatus_releasedonholdreturned", editable: true, cellEditor: 'agSelectCellEditor', cellEditorParams: { values: ['', 'RELEASED', 'ON_HOLD', 'RETURNED'] }, minWidth: 160 },
    { headerName: "Data da coleta", field: "data_liberacao", editable: true, cellEditor: 'agDateStringCellEditor', valueFormatter: dateFormatter, minWidth: 150 },
    ...
    { headerName: "Data da Nota Fiscal (Giant)", field: "data_nfe", editable: true, cellEditor: 'agDateStringCellEditor', valueFormatter: dateFormatter, minWidth: 200 },
    { headerName: "Número NFE (Giant)", field: "numero_nfe", editable: true, minWidth: 220 },
    { headerName: "Data Nota Fiscal (Deloitte)", field: "nftgdt", editable: true, cellEditor: 'agDateStringCellEditor', valueFormatter: dateFormatter, minWidth: 220 },
    { headerName: "Número NFE (Deloitte)", field: "nftg", editable: true, minWidth: 240 },
    { headerName: "Data Entrega BR1", field: "dlvatdestination", editable: true, cellEditor: 'agDateStringCellEditor', valueFormatter: dateFormatter, minWidth: 220 },
    { headerName: "Status Atual Processo", field: "status_impexp", editable: true, cellEditor: 'agSelectCellEditor', cellEditorParams: { values: ['', 'PENDENTE', 'LIBERADO', 'BLOQUEADO', 'CANCELADO'] }, minWidth: 220 },
    { headerName: "Data Estimada Entrega BR1", field: "data_estimada", valueFormatter: dateFormatter, minWidth: 280 },
    { headerName: "Eventos Processo", field: "eventos", editable: true, cellEditor: 'agLargeTextCellEditor', minWidth: 300 },
